<?php
/**
 * File that defines the Link_Wizard_Loader class.
 *
...
class Link_Wizard_Loader {
	...
	/**
	 * Initialise the collection used to maintain the actions and filters.
	 *
	 * @since   1.0.0
	 */
	 ...
	 * @since   1.0.0
	 * @access  private
	 * @param   array  $hooks           The collection of hooks (actions & filters) that is being registered.
