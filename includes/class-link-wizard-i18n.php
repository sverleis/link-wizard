...
class Link_Wizard_I18n {
	...
	public static function get_admin_text( $key ) {
		$texts = array(
			...
			'all_valid_variations' => __( 'All Valid Variations:', 'link-wizard-for-woocommerce' ),
			'ineligible_variations' => __( 'Ineligible Variations:', 'link-wizard-for-woocommerce' ),
			'edit_product' => __( 'Edit', 'link-wizard-for-woocommerce' ),
