 ...
 *
 * This file defines the plugin name, version and hooks for enqueuing admin-specific stylesheets and JavaScript.
 *
 * @package     Link_Wizard_For_WooCommerce
 * @subpackage  Link_Wizard_For_WooCommerce/admin
 * @since       1.0.0
	...
	public function enqueue_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'allValidVariations' => Link_Wizard_I18n::get_admin_text( 'all_valid_variations' ),
				'ineligibleVariations' => Link_Wizard_I18n::get_admin_text( 'ineligible_variations' ),
				'editProduct' => Link_Wizard_I18n::get_admin_text( 'edit_product' ),
